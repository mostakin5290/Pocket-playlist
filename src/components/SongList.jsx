...
const SongList = ({ playlistUrl = '', setPlaylistUrl = () => { }, handelReset = () => { }, handleAdd = () => { }, playlist = [], currentIndex = 0, handlePlayIndex = () => { } }) => {
    return (
        <div className='relative h-auto md:h-[70vh] w-full rounded-2xl p-5 bg-card shadow-2xl'>
                ...
                <div className='flex items-center justify-between gap-4 mb-4'>
                    ...
                    <div className='flex-shrink-0 flex flex-col items-end gap-3'>
                        ...
                        <Button
                            ...
                            style={{ background: 'linear-gradient(90deg,#FF1EA8,#FF56B6)' }}>
                            <Plus size={16} />
                            Add
                        </Button>
                    </div>
                ...
                <div className='mt-2 space-y-2 overflow-auto max-h-[48vh] pr-2'>
                    {playlist.map((item, idx) => (
                        <button
                            ...
                            className={`w-full flex items-center gap-3 p-3 rounded-lg transition-shadow text-left group`}
                            style={{
                                background: idx === currentIndex ? '#101014' : 'transparent',
                                borderLeft: idx === currentIndex ? '4px solid #FF1EA8' : undefined
                            }}
                        >
                            ...
                            <div className='flex flex-col items-end ml-2'>
                                {idx === currentIndex ? (
                                    <div className='inline-flex items-center gap-2 px-2 py-1 rounded-full text-xs font-medium' style={{ background: 'linear-gradient(90deg,#FF1EA8,#FF56B6)' }}>
